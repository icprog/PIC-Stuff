...
void Initialize_PWM(void)
{
    ...
    OC4R =                  0x0000;                 // Set On time (Duty Cycle) OC4 Pin will output high on compare, when timer hits OC4RS, pin is set low
    ...
    OC6R =                  0x0000;                 // Set On time (Duty Cycle) OC6 Pin will output high on compare, when timer hits OC6RS, pin is set low
